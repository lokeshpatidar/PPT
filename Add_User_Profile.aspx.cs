    ...
    public partial class Add_User_Profile : System.Web.UI.Page
    {
        ...
        protected void Btn_Add_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet ds = constr.AddUserProfile(Action: "INSERT", Project_Name: Drp_Project_Name.SelectedValue, USerGroup_Name: Drp_User_Group.SelectedValue, User_Name: txt_User_Name.Text
                ...
                for (i = 0; i < grdINV.Rows.Count; i++)
                {
                    ...
                    if (ChAction.Checked)
                    {
                        ...
                        ds = constr.AddUserProfile(Action: "INSERT_INV", USERID: UserID, Site_ID: T_INVID.Text, INVNAME: INVNAME.Text);
                    }
                }                   
