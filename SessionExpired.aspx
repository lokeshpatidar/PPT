<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SessionExpired.aspx.cs" Inherits="SessionExpired" EnableEventValidation="false" %>
...
<body>
    ...
    <div>
        <table style="width: 490px;">
            ...
            <tr>
                <td style="width: 294px">
                    <asp:HyperLink ID="hLogOut" runat="server" NavigateUrl="~/Auth.aspx" Target="_parent" CssClass="CommonStyle">Click here</asp:HyperLink></td>
            </tr>
            <tr>
